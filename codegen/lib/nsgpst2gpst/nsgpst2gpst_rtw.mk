###########################################################################
## Makefile generated for MATLAB file/project 'nsgpst2gpst'. 
## 
## Makefile     : nsgpst2gpst_rtw.mk
## Generated on : Tue Feb 26 19:53:16 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/nsgpst2gpst.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/alfonsoamayuelas/Documents/PVT-Computation
ARCH                      = maci64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/nsgpst2gpst.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/nsgpst2gpst -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=nsgpst2gpst -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/codegen/lib/nsgpst2gpst/nsgpst2gpst_initialize.cpp $(START_DIR)/codegen/lib/nsgpst2gpst/nsgpst2gpst_terminate.cpp $(START_DIR)/codegen/lib/nsgpst2gpst/nsgpst2gpst.cpp $(START_DIR)/codegen/lib/nsgpst2gpst/rt_nonfinite.cpp $(START_DIR)/codegen/lib/nsgpst2gpst/rtGetNaN.cpp $(START_DIR)/codegen/lib/nsgpst2gpst/rtGetInf.cpp
...
OBJS = nsgpst2gpst_initialize.o nsgpst2gpst_terminate.o nsgpst2gpst.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
...
%.o : $(START_DIR)/codegen/lib/nsgpst2gpst/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/nsgpst2gpst/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
